---
title: "Big Tech and Privacy Alternatives"
description: "Boo Big Tech!"
date: 2025-12-07
tags: ["Big-Tech", "Privacy-Alternatives", "Technology"]
---
...
![](https://res.cloudinary.com/dnkm8pijh/image/upload/v1775998686/privacypack-1024x1024_mhhurv.png)

There have been cases with Google scanning and going through your emails, like in 2022, [a Father got his Gmail account blocked by Google for sending naked pictures of his child to a doctor](https://tuta.com/blog/gmail-naked-picture-blocked), but even though investigations were closed, Google was still not letting the father get back access to the account, this is a example that Google scans through messages for "safety"
...
- Self-Host - If you know what you are doing , you can self-host popular software like Immich (self-hosted Google Photos alternative) or Nextcloud (self-hosted Google Drive alternative), downside is, its unreliable, so it's recommended you use the [3-2-1 backup method](https://www.veeam.com/blog/321-backup-rule.html) for any important data.

- Cloud Hosting - This is like self-hosting at home, but you do it at a cloud hosting service, which they manage the server for you, there are popular options like [DigitalOcean](https://www.digitalocean.com) or [Hostinger](https://www.hostinger.com/uk), but again, its not reliable, and you don't have physical access to the machine, which makes it harder to troubleshoot, again, use the 3-2-1 backup method i have mentioned earlier.
