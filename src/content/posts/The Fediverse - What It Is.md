---
title: "The Fediverse: What It Is"
description: "What Is the Fediverse?"
date: 2026-01-16
tags: ["Privacy-Alternatives", "Technology"]
---
...
![](https://res.cloudinary.com/dnkm8pijh/image/upload/v1775999873/image_iqv0qj.png)

But due to the problems of Account Porting, Bluesky PBC (which used to be an internal research group at Twitter Inc) formed a new protocol called [ATProto](https://atproto.com), which if implemented, gives an Immutable DID and a linked domain (this also allows for verifying people, by supplying a DNS Query of a resource record, or requesting a text file from the web service), It works the same as ActivityPub but one difference is that you can use one identity (one login) for many ATProto services, this also contributes to "Not having too much logins".

![](https://res.cloudinary.com/dnkm8pijh/image/upload/v1776000054/image-1-1024x538_lyedda.png)
...
![](https://res.cloudinary.com/dnkm8pijh/image/upload/v1776000113/Mastodon-Profile-from-Friendica-1024x574_ps5j6d.jpg)
